...
class App extends Component {
  ...
  render() {
    const { photos, firstRender, showMenuButton, isUploadModalOpen } =
      this.state;
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={
              <Collections
                render={(data) => <Photos photos={data} link="collections" />}
              >
          ...
          <Route
            ...
            element={<CollectionsDetails displayButton={this.displayButton} />}
          />
